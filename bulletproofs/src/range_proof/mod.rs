...
impl RangeProof {
    ...
    /// case.
    pub fn verify_single_with_challenge(
        &self,
        bp_gens: &BulletproofGens,
        pc_gens: &PedersenGens,
        transcript: &mut Transcript,
        ...
        self.verify_multiple_with_challenge(bp_gens, pc_gens, transcript, &[*V], challenge, n)
    }
    ...
    pub fn verify_multiple_with_rng<T: RngCore + CryptoRng>(
        ...
        self.verify_multiple_with_challenge(bp_gens, pc_gens, transcript, value_commitments, &c, n)
    }

    /// Verifies an aggregated rangeproof for the given value commitments.
    pub fn verify_multiple_with_challenge(
        &self,
        bp_gens: &BulletproofGens,
        pc_gens: &PedersenGens,
        transcript: &mut Transcript,
