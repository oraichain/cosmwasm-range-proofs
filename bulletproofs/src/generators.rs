...
impl BulletproofGens {
	...
	/// # Inputs
	///
	/// * `gens_capacity` is the number of generators to precompute for each
	///   party.  For rangeproofs, it is sufficient to pass `64`, the maximum
	///   bitsize of the rangeproofs.  For circuit proofs, the capacity must be
	///   greater than the number of multipliers, rounded up to the next power
	///   of two.
	///
	...
	/// Return an iterator over the aggregation of the parties' G generators
	/// with given size `n`.
	...
	/// Return an iterator over the aggregation of the parties' H generators
	/// with given size `n`.
